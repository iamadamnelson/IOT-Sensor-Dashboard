        ...
        <div className="dashboard-container" style={{ 
            ...
            <div className="dashboard-split-view" style={{ display: 'flex', flex: '0 0 600px', gap: '20px', marginBottom: '40px' }}>
                <div className="viewer-pane" style={{ 
                    flex: 2, background: '#000', borderRadius: '12px', border: '1px solid #333', 
                    ...
                    {apsToken ? (
                        <APSViewer 
                            ...
                            urn={MODEL_URN} 
                            sensorData={current} 
                            sensorHistory={history} /* ADDED THIS */
                        />
                    ) : (
                        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', color: '#00f7ff', fontFamily: 'monospace' }}>
                            AUTHENTICATING SECURE VIEWER...
                        </div>
                    )}
                </div>

                <div className="data-pane" style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '20px', overflowY: 'auto' }}>
                    ...
                    <div className="history-section" style={{marginTop: 0}}>
                        <h2 style={{fontSize: '1rem', marginBottom: '10px'}}>LAST 10 MESSAGES</h2>
                        <div className="table-container" style={{minHeight: 'auto'}}>
                            <table className="history-table">
                                <thead>
                                    <tr><th>Time</th><th>Temp</th><th>Hum</th><th>hPa</th></tr>
                                </thead>
                                <tbody>
